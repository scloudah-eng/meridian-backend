#!/bin/bash
# Run this from inside the meridian-backend folder with: bash install-blog4.sh
cat > prisma/seed-blog4.js << 'BLOGEOF'
...
BLOGEOF
echo "Done — seed-blog4.js has been created in prisma/"
ls -la prisma/seed-blog4.js
